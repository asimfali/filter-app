    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div>
        <label className="block text-xs font-medium text-gray-600 mb-1">
          Код <span className="text-gray-400 font-normal">(латиница, используется в API)</span>
        </label>
      ...
      <div>
        <label className="block text-xs font-medium text-gray-600 mb-1">Порядок (order)</label>
    ...
    <div className="flex-1 min-w-0">
      <div className="flex items-center justify-between mb-3">
        <span className="text-sm font-medium text-gray-700">
          ...
          <span className="ml-2 text-xs text-gray-400">code: {axis.code}</span>
        </span>
      ...
      {loading ? (
        ...
        <div className="text-sm text-gray-400 py-8 text-center border-2 border-dashed
          ...
          {values.map(v => (
            <div key={v.id}
              className="flex items-center justify-between bg-gray-50 hover:bg-gray-100
                         border border-gray-200 rounded-lg px-3 py-2 group transition-colors">
              <div className="flex items-center gap-3">
                <span className="text-xs text-gray-400 w-6 text-right">{v.sort_order}</span>
...
export default function ParameterEditorPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg shadow px-5 py-4 flex items-center gap-4">
        ...
        <div>
          <label className="block text-xs text-gray-500 mb-1">Тип продукции</label>
      ...
      {typeId && (
        <div className="flex gap-4">
          ...
          <div className="bg-white rounded-lg shadow p-4 w-64 shrink-0">
            <div className="flex items-center justify-between mb-3">
              <span className="text-sm font-medium text-gray-700">Оси параметров</span>
