...
for FILE in $FILES; do
  ...
  # Фоны
  sed -i 's/bg-white/bg-white dark:bg-neutral-900/g' "$FILE"
  sed -i 's/bg-neutral-50/bg-neutral-50 dark:bg-neutral-950/g' "$FILE"
  sed -i 's/bg-neutral-100/bg-neutral-100 dark:bg-neutral-800/g' "$FILE"
  sed -i 's/bg-neutral-200/bg-neutral-200 dark:bg-neutral-700/g' "$FILE"
  ...
  # Hover фоны
  sed -i 's/hover:bg-neutral-50/hover:bg-neutral-50 dark:hover:bg-neutral-800/g' "$FILE"
  sed -i 's/hover:bg-neutral-100/hover:bg-neutral-100 dark:hover:bg-neutral-700/g' "$FILE"

  # Инпуты и селекты — добавить dark фон
  sed -i 's/focus:ring-blue-500"/focus:ring-blue-500 dark:bg-neutral-800 dark:text-white dark:border-gray-600"/g' "$FILE"
